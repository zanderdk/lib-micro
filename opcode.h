...
#define _MOVUPD (0x5f9UL << 32)
#define _SHUFPD (0x5faUL << 32)
...
#define _MULPD (0x6f1UL << 32)
#define _SQRTPD (0x6f5UL << 32)
#define _DIVPD (0x6f6UL << 32)
#define _ADDPD (0x6f8UL << 32)
#define _SUBPD (0x6fcUL << 32)
#define _MINPD (0x6fdUL << 32)
#define _CMPPD (0x6feUL << 32)
#define _MAXPD (0x6ffUL << 32)
